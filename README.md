...
```bash
$ git clone https://github.com/nholuongut/github-cheat-sheet
```
...
If you go to the repo's [Branches](https://github.com/nholuongut/github-cheat-sheet/branches) page, next to the Commits button:
...
Add `.pibb` to the end of any Gist URL ([like this](https://gist.github.com/nholuongut/10545817.pibb)) in order to get the *HTML-only* version suitable for embedding in any other site.

Gists can be treated as a repository so they can be cloned like any other:

```bash
$ git clone https://gist.github.com/nholuongut/10545817
```
...
Password for 'https://nholuongut@gist.github.com':
```
...
When on a repository page, keyboard shortcuts allow you to navigate easily.
 ...
 - Pressing `y` **when looking at a file** (e.g., `https://github.com/nholuongut/github-cheat-sheet/blob/master/README.md`) will change your URL to one which, in effect, freezes the page you are looking at. If this code changes, you will still be able to see what you saw at that current time.
...
To link to an issue in another repository, `{user}/{repo}#ISSUE_NUMBER`, e.g., `nholuongut/toc#12`.
...
For example, to syntax highlight Ruby code in your Markdown files write:
    ...
    table.add_row('Tim Green', 'nholuongut@gmail.com')
    puts table.to_s
    ```
...
```markdown
[Link to a header](#nholuong-section)
...
```
https://github.com/nholuongut/github-cheat-sheet/pull/15
https://github.com/nholuongut/github-cheat-sheet/pull/15.diff
https://github.com/nholuongut/github-cheat-sheet/pull/15.patch
```
...
e.g. [https://github.com/nholuongut.keys](https://github.com/nholuongut.keys)
...
[remote "origin"]
    ...
    url = git@github.com:nholuongut/github-cheat-sheet.git
```
...
*This can be aliased using the instructions found [here](https://github.com/nholuongut/github-cheat-sheet#aliases).*
